...
```bash
docker run -it -d -p 8080:80 diamol/ch02-hello-diamol-web
docker exec {id} ls /usr/local/apache2/htdocs
docker container cp index.html {id}:/usr/local/apache2/htdocs/index.html
```
